...
Pronounced "Ti d'Homme" in French, is short for *petite domotique*. +
...
** *Total (W)* : Power level at the moment
** *Costs (€)* : Computed costs, taking Low/High hours prices into account
...
* Energy Timeline Xd (kWh or € cost):
** *Bars* : Energy consummed by hour, day, or week slots and for each of the 6 *Periode* costs (EDF provider contract)
** *Total* : At top of each bar, total as kWh, or € cost

* Clamps Timeline Xd (kWh or € cost):
** *Bars* : Energy consummed by hour, day, or week slots and for each of the 6 *Periode* costs (EDF provider contract)
** *Total* : At top of each bar, total as kWh, or € cost
